...
public class MainActivity extends AppCompatActivity {
    ...
    private void fetchBooksData(String query) {
        ...
        bookService = RetrofitInstance.getRetrofitInstance().create(BookService.class);
    ...
    private class BookHolder extends RecyclerView.ViewHolder {
        ...
        private TextView bookNumberOfPages;
        private Book book;
        ...
        public BookHolder (LayoutInflater inflater, ViewGroup parent)
        {
            ...
            bookNumberOfPages = itemView.findViewById(R.id.number_of_pages);
        }
        ...
        public void bind(Book book)
        {
            if (book != null && checkNullOrEmpty(book.getTitle()) && book.getAuthors() != null)
            {
                ...
                if (book.getCover() != null)
                    Picasso.with(itemView.getContext()).load(IMAGE_URL_BASE + book.getCover() + "-S.jpg").placeholder(R.drawable.ic_book).into(bookImageView);
                else
